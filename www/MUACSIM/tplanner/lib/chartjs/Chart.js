...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		...
		getPixelForTick: function(index) {
			...
			if (this.getPixelForOffset(ticks[index].value) > 0 && this.getPixelForOffset(ticks[index].value) < window.minTickX) window.minTickX = this.getPixelForOffset(ticks[index].value);
			if (this.getPixelForOffset(ticks[index].value) > 0 && this.getPixelForOffset(ticks[index].value) > window.maxTickX) window.maxTickX = this.getPixelForOffset(ticks[index].value);
