...
$(document).ready(function(){
	...
	if (document.cookie.match(/authAppUserID=7/)) $(".nav-item:first").after('<li class="nav-item"><a class="nav-link" style="padding:0.5em 2em;" href="../../Planner/views/ManageSwaps.html">Manage swaps</a></li>');
