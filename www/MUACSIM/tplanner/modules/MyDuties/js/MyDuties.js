	...
	document.addEventListener("deviceready",function(){
		...
		pn.on("registration",function(data){
			if (navigator.userAgent.match(/i(Phone|Pad)/)) {
				$.vPOST("/MUACSIM/tplanner/modules/MyDuties/server/saveAPNS.php",{apnsID:data.registrationId,appVersion:'1.5.6'},function(){});
			} else {
				$.vPOST("/MUACSIM/tplanner/modules/MyDuties/server/saveFCM.php", { fcmID:data.registrationId,appVersion:'1.5.6'},function(){});
			}
		});
