$(document).ready(function(){
	...
	$.vPOST("/MUACSIM/tplanner/modules/Planner/server/readSimEvents.php",null,function(resp){
		...
		$("#calendar1").fullCalendar({
			...
			selectable          : true,
			select              : false,
			viewRender          : function( ){setTimeout(function(){$("[data-toggle=tooltip]").tooltip();$(".needs-mfs .fc-content").append('<span class="badge badge-default" style="position:absolute;right:0;padding:1px 2px 2px 2px;">MFS</span>')},100)},
			timeFormat          : 'HH:mm',
